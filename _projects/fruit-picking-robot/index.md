...
Our team designed and built a fruit picking robot capable of navigating an 8' x 12' orchard, identifying target fruit (limes, plums, or oranges), and harvesting them without damage. The robot combines a mobile drivetrain, a vertically adjustable picking mechanism, and a control system supporting both tele-op and autonomous modes.
...
| Actuation | 2x VEX V5 Smart Motors, 18:1 reduction |
...
| Actuation | 1x VEX V5 Smart Motor, 18:1 reduction |
...
1. Climb the 20 degree ramp using tilt feedback
